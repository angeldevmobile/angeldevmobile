...
| 📋 **Gestión de Planillas** | Plataforma web desarrollada con **Flutter** (frontend) y **Java** (backend) para administrar planillas de empleados. Enfocada en eficiencia operativa y experiencia intuitiva. | 🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩 100% ✅ [🌐 Disponible aquí](https://deploy-flutter-planilla.onrender.com) |
---
